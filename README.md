...
* #### Savox Servo arm C9 for original horn <sub>*May 28, 2024*</sub>
  * In my opinion, the weakest point of the ERCF are the servo splines. This servo arm solves that problem by using the original 4 branches horn delivered with the Savox servo. It will also work with trimmed MG90 horn. 
